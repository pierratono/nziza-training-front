...
const CheckPage = () => (
    ...
    <Layout>
        <SEO title="Member" />
        <section id="page-banner" className="pt-105 pb-130 bg_cover" data-overlay={8} style={{ backgroundImage: 'url(images/page-banner-3.jpg)' }}>
                        ...
                        <div className="page-banner-cont">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Lorem</li>
                                </ol>
                            </nav>
                                                ...
                                                <div className="singel-course mt-30">
                                                    ...
                                                    <div className="cont border">
                                                        ...
                                                        <div className="course-teacher">
                                                            ...
                                                            <div className="admin">
                                                                <ul>
                                                                    <li><a href="#"><i className="fa fa-user" /><span>31</span></a></li>
                                                                    <li><a href="#"><i className="fa fa-heart" /><span>10</span></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-lg-12">
                                                        <div className="form-singel">
                                                            <div className="rate-wrapper">
                                                                ...
                                                                <div className="rate">
                                                                    <div className="rate-item"><i className="fa fa-star" aria-hidden="true" /></div>
                                                                    <div className="rate-item"><i className="fa fa-star" aria-hidden="true" /></div>
                                                                    <div className="rate-item"><i className="fa fa-star" aria-hidden="true" /></div>
                                                                    <div className="rate-item"><i className="fa fa-star" aria-hidden="true" /></div>
                                                                    <div className="rate-item"><i className="fa fa-star" aria-hidden="true" /></div>
